...
public class MedicPageController extends SceneController {
    ...
    @FXML
    protected void onBackToLog() { this.changeScene(SCENE_IDENTIFIER.MEDIC);}
    @FXML
    protected void  onICButton() { this.changeScene(SCENE_IDENTIFIER.IC);}
    @FXML
    protected void onMorgueButton(){this.changeScene(SCENE_IDENTIFIER.MORGUE);}
}
